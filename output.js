//Wed Apr 30 2025 04:25:15 GMT+0000 (Coordinated Universal Time)
...
var f0003 = function () {
  ...
  var _0x4f5c1d = _0x3673a6 && "function" == typeof _0x3673a6.isTypeSupported && _0x3673a6.isTypeSupported("video/mp4; codecs=\"avc1.42E01E,mp4a.40.2\"");
  var _0x1a9429 = !_0x5b54da || _0x5b54da.prototype && "function" == typeof _0x5b54da.prototype.appendBuffer && "function" == typeof _0x5b54da.prototype.remove;
...
function reportHls(_0x224d7e) {
  ...
  var _0x130cc9 = f0001(JSON.stringify(_0x3e2999), "aK7ZWN71if8mN60SMl99RBvIwcEUNEaS");
  var _0x32fc6d = {
    data: _0x130cc9
  };
...
function LoadPlay() {
  ...
  if (DEV_PLAY == "thang") {
    ...
    {
      var _0x23f36b = document.referrer.split("/").slice(0, 3).join("/") || window.self.location.ancestorOrigins[0] || "";
    }
  }
  if (VerLoad == "") {
    {
  ...
  let _0x972dd1 = f0001(JSON.stringify(_0x32b828), "vlVbUQhkOhoSfyteyzGeeDzU0BHoeTyZ");
  var _0x30ca8c = CryptoJS.MD5(_0x972dd1 + "KRWN3AdgmxEMcd2vLN1ju9qKe8Feco5h").toString();
  $.post(DOMAIN_API + "/playiframe", {
      ...
      if (_0x2f3fed) {
        {
          if (_0x2f3fed.status == 0) {
            ...
            if (_0x2f3fed.status == 1) {
              {
                if (_0x2f3fed.type == "url-m3u8-encv1") {
                  {
                    var _0x65db9a = f0002(_0x2f3fed.data, "oJwmvmVBajMaRCTklxbfjavpQO7SZpsL");
...
function AjaxError(_0xab09ed, _0x11ab74) {
  if (_0xab09ed.status == 0) {
    ...
    if (_0xab09ed.status == 404) {
      {
        alert("Requested URL not found.");
      }
    } else {
      if (_0xab09ed.status == 500) {
        {
